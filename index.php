...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
		    			<div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">9083730153</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
						    <span class="text">ritwikchakraborty.ritwik@email.com</span>
					    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
			...
			<li class="nav-item nav-link"><a href="registerp.php" class="nav-link"><span>Sign Up </span></a></li>
							<?php
    session_start();
    ...
    //session is a way to store information (in variables) to be used across multiple pages.
    if(isset($_SESSION['username'])){  ?>
							 <li class="nav-item"><a href="logout.php" class="nav-link"><span>Sign Out</span></a></li>
	                            <?php }?>
	          ...
	          <li class="nav-item cta mr-md-2"><a href="book.php" class="nav-link">Appointment</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
	            ...
	            <p><a href="book.php" class="btn btn-primary py-3 px-4">Make an appointment</a></p>
            </div>
          </div>
        </div>
      </div>
    			...
    			<div class="col-md-6 col-lg-7 pl-lg-5 py-md-5">
    				<div class="py-md-5">
			          ...
			          <div class="col-md-12 heading-section ftco-animate p-4 p-lg-5">
			            ...
			            <p><a href="book.php" class="btn btn-primary py-3 px-4">Make an appointment</a> <a href="registerd.php" class="btn btn-secondary py-3 px-4">Register as Doctor</a></p>
			          </div>
			        </div>
		        </div>
	        </div>
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-md-9 text-center">
						...
						<p class="mb-0"><a href="index1.php" class="btn btn-white px-4 py-3">Scout Doctors</a></p>
					</div>
				</div>
			</div>
		</section>
    					...
    					<div class="col-md-4">
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<h3><a href="controller.php?special=neurology&filter=login">Neurology</a></h3>  <!--  here we add reg page -->
    						...
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<h3><a href="controller.php?special=surgical&filter=login">Surgical</a></h3> <!--  here we add reg page -->
    								<p>Far far away, behind the word mountains</p>
    							</div>
    						</div>
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<h3><a href="controller.php?special=cardiologist&filter=login">Cardiologist</a></h3> <!--  here we add reg page -->
    								<p>Far far away, behind the word mountains</p>
    							</div>
    						</div>
    					</div>
    					...
    					<div class="col-md-4">
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<h3><a href="controller.php?special=general&filter=login">General</a></h3> <!--  here we add reg page -->
    								<p>Far far away, behind the word mountains</p>
    							</div>
    						</div>
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<h3><a href="controller.php?special=ginocologist&filter=login">Ginocologist</a></h3> <!--  here we add reg page -->
    								<p>Far far away, behind the word mountains</p>
    							</div>
    						</div>
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<h3><a href="controller.php?special=traumatology&filter=login">Traumatology</a></h3> <!--  here we add reg page -->
    								<p>Far far away, behind the word mountains</p>
    							</div>
    						</div>
    					</div>
    					...
    					<div class="col-md-4">
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<h3><a href="controller.php?special=nuclearmagnetic&filter=login">Nuclear Magnetic</a></h3> <!--  here we add reg page -->
    								<p>Far far away, behind the word mountains</p>
    							</div>
    						</div>
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<h3><a href="controller.php?special=ray&filter=login">X-ray</a></h3> <!--  here we add reg page -->
    								<p>Far far away, behind the word mountains</p>
    							</div>
    						</div>
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<h3><a href="controller.php?special=cardiology&filter=login">Cardiology</a></h3> <!--  here we add reg page -->
    								<p>Far far away, behind the word mountains</p>
    							</div>
    						</div>
    					</div>
            ...
            <p>Separated they live in. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country</p>
				...
				<div class="row">
					<div class="col-md-6 col-lg-3 ftco-animate">
		              ...
		              <p><a href="#" class="btn btn-primary">Book now</a></p> --><!-- Ithink we need this-->
	              </div>
							</div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row d-flex align-items-center">
					<div class="col-md-5 heading-section heading-section-white">
						...
						<p class="mb-0"><a href="book.php" class="btn btn-secondary px-4 py-3">Make an appointment</a></p>
					</div>
					<div class="col-md-7">
						<div class="row pt-4">
